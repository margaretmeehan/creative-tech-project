...
public class PiUI : MonoBehaviour
{
    ...
    /// <summary>
    /// Accept Button For The Menu. The Button that will select the hovered option.
    /// </summary>
    [HideInInspector]
    public bool joystickButton;
    /// <summary>
    /// A 2D normalized vector for the direction the input is, basically just the angle the stick is.
    /// </summary>
    [HideInInspector]
