...
class Attachments {
    ...
    getAttachmentInfo(attachmentId, options, callback) {
        ...
        if (!callback) {
            ...
            msRest.promiseToCallback(this.getAttachmentInfoWithHttpOperationResponse(attachmentId, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
    ...
    getAttachment(attachmentId, viewId, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.getAttachmentWithHttpOperationResponse(attachmentId, viewId, options).then((operationRes) => {
            ...
            msRest.promiseToCallback(this.getAttachmentWithHttpOperationResponse(attachmentId, viewId, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
