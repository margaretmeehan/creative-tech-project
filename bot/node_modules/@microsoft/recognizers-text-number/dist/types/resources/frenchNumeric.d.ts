export declare namespace FrenchNumeric {
    ...
    const TenToNineteenIntegerRegex = "(dix\\Wneuf|dix\\Whuit|dix\\Wsept|seize|quinze|quatorze|treize|douze|onze|dix)";
    const TensNumberIntegerRegex = "(octante|vingt|trente|quarante|cinquante|soixante-dix|soixante|septante|huitante|quatre-vingt-dix|nonante)";
    ...
    const PrefixCardinalDictionary: ReadonlyMap<string, number>;
    const SufixOrdinalDictionary: ReadonlyMap<string, number>;
