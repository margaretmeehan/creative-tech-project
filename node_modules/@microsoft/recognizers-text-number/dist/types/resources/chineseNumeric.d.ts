export declare namespace ChineseNumeric {
    ...
    const PointRegexChsStr = "[点點\\.．]";
    const AllFloatRegexChs: string;
    const NumbersWithoutPercent: string;
    const NumbersWithPercent: string;
    const PointRegexChs: string;
